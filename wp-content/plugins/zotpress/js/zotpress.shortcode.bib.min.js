...
{var sortby=jQuery(".ZP_SORTBY",$instance).text();var orderby=jQuery(".ZP_ORDER",$instance).text();var sortOrder="data-zp-author-date";if(sortby=="date")
sortOrder="data-zp-date-author";typicalSort(zp_items,sortby,sortOrder,orderby);if(zp_params.zpTitle!==!1)
...
titleSortedEntries[orderedType].reverse();else if(zp_params.zpTitle=="itemtype"&&sortby=="date")
