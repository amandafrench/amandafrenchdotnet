<?php
	...
	if ($zp_xml === false)
	{
		...
		if ( $zp_xml !== false && strlen(trim($zp_xml["json"])) > 0 )
		{
			...
			header( "Content-Disposition:inline;filename=".$zp_filename);
			echo $zp_xml["json"];
		}
		else {
