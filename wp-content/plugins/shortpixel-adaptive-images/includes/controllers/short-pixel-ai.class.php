...
class ShortPixelAI {
	...
	public function parse_elementor_css( $post_css, $element ) {
		...
		$api_url_only_store = $this->get_api_url( false, false, 'svg' );
...
//        }
    ...
    public function toolbar_sniper_scripts() {
        ...
        wp_register_script( 'spai-sniper', 'https://' . (SHORTPIXEL_AI_DEBUG ? 'dev.shortpixel.ai' : parse_url($this->settings->behaviour->api_url, PHP_URL_HOST)) . '/assets/js/snip-3.0.min.js', [], SPAI_SNIP_VERSION, true );
